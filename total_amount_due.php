...
if(isset($_POST['submit'])){
    ...
    // compute cu/m
    $cu1 = $f_pres - $f_prev;
    // $cu1 = round(floatval($cu1), 2);
    $cu2 = $s_pres - $s_prev;
    // $cu2 = round(floatval($cu2), 2);
    $cu3 = $t_pres - $t_prev;
    // $cu3 = round(floatval($cu3), 2);
    $cu4 = $frt_pres - $frt_prev;
    // $cu4 = round(floatval($cu4), 2);
                        ...
                        <!-- First Floor -->
                            ...
                            <div class="input-field col s6">
                              ...
                              <div class="input-field col s12">
                                <input type="text" class="datepicker" name="date" placeholder="Billing Date Received" value="<?php echo $row['date']?>">
